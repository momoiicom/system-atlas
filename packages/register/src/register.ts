...
if (process.env.NODE_ENV === "production") {
  ...
  (globalThis as Record<symbol, unknown>)[Symbol.for("@system-atlas/runtime")] = getAtlasRuntime;
  ...
  for (const extension of [".cjs", ".js"]) {
    ...
    Module._extensions[extension] = (module, filename) => {
      if (filename.includes("node_modules") || filename.includes("/@system-atlas/register/")) return original(module, filename);
